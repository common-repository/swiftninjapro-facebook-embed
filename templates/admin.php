...
$SwiftNinjaProSettings_PluginName = 'FacebookEmbed';
$SwiftNinjaProSettings_PluginDisplayName = 'Facebook Embed';
$SwiftNinjaProSettings_PluginPermalinkName = 'facebook-embed';
...
$SwiftNinjaProSettingsDefaultUrl = SwiftNinjaPro_settings_GetOption('DefaultUrl', 'manage_options');
...
echo '<h3>[facebook]</h3><h4> Embeds facebook page with default url</h4>';
echo '<h3>[facebook url="SwiftNinjaPro"]</h3><h4> Embeds facebook page with selected url</h4>';

echo '<br>';
SwiftNinjaProSettingAddInput($SwiftNinjaProSettingsDefaultUrl, 'DefaultUrl', 'Default Facebook Page Url', '', '500px', 'false');

echo '<br><br><input type="submit" value="Save" class="swiftninjapro-settings-button">';

echo '<br><br><img width="90%" style="border: solid 2px; border-radius: 10px;" src="'.plugins_url('example-image1.png', __FILE__).'"></img>';
